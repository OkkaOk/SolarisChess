...
public static class PieceSquareTable
{
	...
	{
		int index = square.AsInt();
		if (isWhite)
		{
			int file = square.File.AsInt();
			int rank = square.Rank.AsInt();
			rank = 7 - rank;
			index = rank * 8 + file;
		}
	...
	public static readonly int[] pawnMiddle = {
		  0,   0,   0,   0,   0,   0,  0,   0,
		 98, 134,  61,  95,  68, 126, 34, -11,
		 -6,   7,  26,  31,  65,  56, 25, -20,
		-14,  13,   6,  21,  26,  12, 17, -23,
		-27,  -2,  -5,  15,  23,   6, 10, -25,
		-26,  -4,  -4, -10,   3,   3, 33, -12,
	...
	public static readonly int[] knightMiddle = {
		-167, -89, -34, -49,  61, -97, -15, -107,
		 -73, -41,  72,  36,  23,  62,   7,  -17,
		 -47,  60,  37,  65,  84, 129,  73,   44,
		  -9,  17,  19,  53,  44,  69,  18,   22,
	...
	public static readonly int[] bishopMiddle = {
	...
	public static readonly int[] rookMiddle = {
	...
	public static readonly int[] queenMiddle = {
